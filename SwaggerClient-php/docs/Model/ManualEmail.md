...
**html_body** | **string** | The html version of the body of the message. | [optional] 
**text_body** | **string** | The text version of the body of the message. | [optional] 
**open_tracking** | **bool** | The option to track if the message is opened. | [optional] [default to false]
**click_tracking** | **bool** | The option to track if the message is clicked. | [optional] [default to false]
