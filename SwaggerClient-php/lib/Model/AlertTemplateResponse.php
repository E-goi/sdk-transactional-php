...
/**
 * AlertTemplateResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AlertTemplateResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlertTemplateResponse';
...
'channel' => 'getChannel'    ];
     ...
     * Sets channel
     *
     * @param string $channel the text version of the message.
     *
     * @return $this
     */
