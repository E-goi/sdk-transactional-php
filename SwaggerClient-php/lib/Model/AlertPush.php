 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AlertPush implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Alert_Push';
...
'to' => '\Swagger\Client\Model\ToPushAlertObject[]'    ];
...
'to' => 'getTo'    ];
     ...
     *
     * @param string $alert_template_name the name of the alert template to use.
     *
     * @return $this
     */
     ...
     * Gets to
     *
     * @return \Swagger\Client\Model\ToPushAlertObject[]
     */
     ...
     * Sets to
     *
     * @param \Swagger\Client\Model\ToPushAlertObject[] $to A list of the devices to send the notification.
     *
     * @return $this
     */
