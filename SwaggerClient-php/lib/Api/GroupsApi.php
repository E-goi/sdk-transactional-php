...
class GroupsApi
{
     ...
     */
    public function listGroups($channel = null)
    {
        list($response) = $this->listGroupsWithHttpInfo($channel);
        return $response;
    }
     ...
     */
    public function listGroupsWithHttpInfo($channel = null)
    {
        $returnType = '\Swagger\Client\Model\GroupResponse[]';
        $request = $this->listGroupsRequest($channel);
     ...
     */
    public function listGroupsAsync($channel = null)
    {
        return $this->listGroupsAsyncWithHttpInfo($channel)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listGroupsAsyncWithHttpInfo($channel = null)
    {
        $returnType = '\Swagger\Client\Model\GroupResponse[]';
        $request = $this->listGroupsRequest($channel);
     ...
     */
    protected function listGroupsRequest($channel = null)
    {

        $resourcePath = '/v2/groups';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
