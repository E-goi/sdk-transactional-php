 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AlertEmail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Alert_Email';
...
'sender_id' => 'string',
'to' => '\Swagger\Client\Model\ToEmailAlertObject[]'    ];
...
'to' => 'getTo'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['alert_template_name'] === null) {
            $invalidProperties[] = "'alert_template_name' can't be null";
        }
     ...
     *
     * @param string $alert_template_name the name of the alert template to use. Already has to exist in the system.
     *
     * @return $this
     */
     ...
     * Sets sender_id
     *
     * @param string $sender_id the id to identify the sender.
     *
     * @return $this
     */
     ...
     * Gets to
     *
     * @return \Swagger\Client\Model\ToEmailAlertObject[]
     */
     ...
     * Sets to
     *
     * @param \Swagger\Client\Model\ToEmailAlertObject[] $to a list of recipients of the alert.
     *
     * @return $this
     */
