...
/**
 * MobileAppRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MobileAppRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MobileAppRequest';
...
'auth_key' => 'getAuthKey'    ];
     ...
     * Sets sandbox
     *
     * @param bool $sandbox Option to send the notification in a Sandbox Environment in iOS devices.
     *
     * @return $this
     */
     ...
     * Sets certificate
     *
     * @param string $certificate The certificate of the app
     *
     * @return $this
     */
     ...
     * Sets auth_key
     *
     * @param string $auth_key The authentication key to send push messages to android.
     *
     * @return $this
     */
